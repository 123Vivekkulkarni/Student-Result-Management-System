...
class ResultClass:
    def __init__(self,root):
        ...
        txt_marks_ob = Entry(self.root,textvariable=self.var_marks_ob, font=("goudy old style",15,"bold"), bg="lightyellow").place(x=280, y=280, width=320)
        ...
        #-------image-----------
        self.bg_image = Image.open("F:/Student Result Management System/images/result.jpg")
