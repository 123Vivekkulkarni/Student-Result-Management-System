...
class RMS:
    def __init__(self,root):
        ...
        #-------Icons---------
        self.logo_dash = ImageTk.PhotoImage(file="F:\Student Result Management System\images\logo_p.png")
        ...
        #-----Content-window------
        self.bg_image = Image.open("F:/Student Result Management System/images/bg.png")
