...
class StudentClass:
    def __init__(self,root):
        ...
        #-----Title-------
        title = Label(self.root, text="Manage Student Details", font=("goudy old style", 25, "bold"), bg="#033054", fg="white").place(x=10, y = 15, width=1180, height=35)
        ...
        self.fetch_course()
        txt_dob = Entry(self.root,textvariable=self.var_dob, font=("goudy old style",15,"bold"), bg="lightyellow").place(x=485, y=60, width=200)
        ...
        txt_addmission = Entry(self.root,textvariable=self.var_a_date,font=("goudy old style",15,"bold"), bg="lightyellow").place(x=485, y=140,width=200)
        ...
        txt_Search_rollno = Entry(self.root,textvariable=self.search_var, font=("goudy old style",15,"bold"), bg="lightyellow").place(x=850, y=60, width=190)
